...
public class ArticulosController {
    ...
    public List<Articulos> getArticulo(){
        ...
        return articulosService.getArticulo();
    }

    @PostMapping("/insertar")
    public Articulos insertarArticulos(@RequestBody Articulos articulos){
        return articulosService.insertarArticulos(articulos);
    }
